// convert_kaggle_h5ad_to_parquet suggestions_elior_build
// 
...
meta = [
        ...
        "arguments" : [
          {
            ...
            "name" : "--input_train",
            "example" : [
              "resources/neurips-2023-kaggle/12_de_by_cell_type_train.h5ad"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
          ...
          },
          {
            ...
            "name" : "--input_test",
            "example" : [
              "resources/neurips-2023-kaggle/12_de_by_cell_type_test.h5ad"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
      ...
      },
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "name" : "--output_id_map",
            "example" : [
              "resources/neurips-2023-kaggle/id_map.csv"
            ],
            "must_exist" : true,
            "create_parent" : true,
            "required" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/process_dataset/convert_kaggle_h5ad_to_parquet/"
      }
    ],
    "info" : {
      ...
      "type_info" : {
        ...
        "description" : "Convert dataset from h5ad files into training and test parquet files.\n"
      }
    },
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/process_dataset/convert_kaggle_h5ad_to_parquet/config.vsh.yaml",
    "platform" : "nextflow",
...
par = {
  ...
  'input_single_cell_h5ad': $( if [ ! -z ${VIASH_PAR_INPUT_SINGLE_CELL_H5AD+x} ]; then echo "r'${VIASH_PAR_INPUT_SINGLE_CELL_H5AD//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/task/process_dataset/convert_kaggle_h5ad_to_parquet",
    "tag" : "suggestions_elior_build"
  },
  "label" : [
    "midtime",
    "midmem",
