    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/metrics/mean_cosine_sim/"
      }
    ],
    "test_resources" : [
      {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/metrics/mean_cosine_sim",
    "tag" : "main_build"
  },
  "label" : [
    "midtime",
