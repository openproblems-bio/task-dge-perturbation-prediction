    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/metrics/mean_correlation/"
      }
    ],
    "test_resources" : [
      {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/metrics/mean_correlation",
    "tag" : "main_build"
  },
  "label" : [
    "midtime",
