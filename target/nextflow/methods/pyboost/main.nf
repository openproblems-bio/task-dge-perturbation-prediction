...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_perturbation_prediction/task_perturbation_prediction/src/methods/pyboost/"
      },
      {
        "type" : "file",
        "path" : "helper.py",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_perturbation_prediction/task_perturbation_prediction/target/nextflow/methods/pyboost",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'predictor_names': $( if [ ! -z ${VIASH_PAR_PREDICTOR_NAMES+x} ]; then echo "r'${VIASH_PAR_PREDICTOR_NAMES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_perturbation_prediction/methods/pyboost",
    "tag" : "build-main"
  },
  "label" : [
    "midtime",
