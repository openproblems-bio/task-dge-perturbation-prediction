// lgc_ensemble_predict suggestions_elior_build
// 
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/methods/lgc_ensemble_predict/"
      },
      {
        "type" : "file",
...
par = {
  ...
  'model_files': $( if [ ! -z ${VIASH_PAR_MODEL_FILES+x} ]; then echo "r'${VIASH_PAR_MODEL_FILES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/methods/lgc_ensemble_predict",
