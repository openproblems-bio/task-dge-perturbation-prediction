...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task_perturbation_prediction/task_perturbation_prediction/src/methods/scape/"
      }
    ],
    "test_resources" : [
      {
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task_perturbation_prediction/task_perturbation_prediction/target/nextflow/methods/scape",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'n_genes_enhanced': $( if [ ! -z ${VIASH_PAR_N_GENES_ENHANCED+x} ]; then echo "int(r'${VIASH_PAR_N_GENES_ENHANCED//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'n_drugs': $( if [ ! -z ${VIASH_PAR_N_DRUGS+x} ]; then echo "int(r'${VIASH_PAR_N_DRUGS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_n_top_drugs': $( if [ ! -z ${VIASH_PAR_MIN_N_TOP_DRUGS+x} ]; then echo "int(r'${VIASH_PAR_MIN_N_TOP_DRUGS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_perturbation_prediction/methods/scape",
    "tag" : "build/main"
  },
  "label" : [
    "hightime",
