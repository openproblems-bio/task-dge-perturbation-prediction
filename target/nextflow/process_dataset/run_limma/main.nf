// run_limma suggestions_elior_build
// 
    ...
    "arguments" : [
      {
        ...
        "name" : "--input",
        "example" : [
          "resources/neurips-2023-data/pseudobulk_cleaned.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
      ...
      },
      {
        ...
        "name" : "--output",
        "example" : [
          "resources/neurips-2023-data/de.h5ad"
        ],
        "must_exist" : true,
        "create_parent" : true,
        "required" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/process_dataset/run_limma/"
      }
    ],
    "info" : {
      ...
      "type_info" : {
        "label" : "Limma",
        "summary" : "Run limma",
        "description" : "Run limma for the DGE regression task.\n"
      }
    },
    "status" : "enabled",
...
par <- list(
  ...
  "input_splits" = $( if [ ! -z ${VIASH_PAR_INPUT_SPLITS+x} ]; then echo -n "strsplit('"; echo -n "$VIASH_PAR_INPUT_SPLITS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "', split = ';')[[1]]"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/process_dataset/run_limma",
