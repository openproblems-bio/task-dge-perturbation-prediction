...
meta = [
  ...
  "functionality" : {
    ...
    "info" : {
      ...
      "type_info" : {
        "label" : "Filter pseudobulked data",
        "summary" : "Filter the genes and compounds",
        "description" : "Filter the pseudobulked single-cell dataset for the DGE regression task.\n"
      }
    },
    "status" : "enabled",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/target/nextflow/process_dataset/clean_pseudobulk",
    "viash_version" : "0.8.6",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/process_dataset/clean_pseudobulk",
    "tag" : "main_build"
  },
  "label" : [
    "midtime",
