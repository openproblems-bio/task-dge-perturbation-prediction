...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/src/task/process_dataset/clean_sc_counts/"
      }
    ],
    "info" : {
      ...
      "type_info" : {
        "label" : "Clean dataset",
        "summary" : "Clean up the single-cell dataset",
        "description" : "Clean up the single-cell dataset for the DGE regression task.\n"
      }
    },
    "status" : "enabled",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "output" : "/home/runner/work/task-dge-perturbation-prediction/task-dge-perturbation-prediction/target/nextflow/process_dataset/clean_sc_counts",
    "viash_version" : "0.8.5",
...
par = {
  ...
  'lincs_id_compound_mapping': $( if [ ! -z ${VIASH_PAR_LINCS_ID_COMPOUND_MAPPING+x} ]; then echo "r'${VIASH_PAR_LINCS_ID_COMPOUND_MAPPING//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task-dge-perturbation-prediction/process_dataset/clean_sc_counts",
    "tag" : "main_build"
  },
  "label" : [
    "midtime",
